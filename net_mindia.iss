...
[Setup]
AppName=MinDia
AppVerName=MinDia Version 0.97.4
...
[Files]
Source: "release\net_mindia.exe"; DestDir: "{app}"; Components: main
Source: "release\net_minsrv.dll"; DestDir: "{app}"; Components: main
Source: "release\net_gendev.dll"; DestDir: "{app}"; Components: main
Source: "release\net_mindiapyc.dll"; DestDir: "{app}"; Components: script
...
Source: "c:\windows\system32\PYTHON24.DLL"; DestDir: "{app}"; Components: script
Source: "mjpeg\cygwin1.dll"; DestDir: "{app}"; Components: movie
Source: "mjpeg\jpeg2yuv.exe"; DestDir: "{app}"; Components: movie
Source: "mjpeg\yuv2lav.exe"; DestDir: "{app}"; Components: movie
Source: "mjpeg\lavaddwav.exe"; DestDir: "{app}"; Components: movie
Source: "mjpeg\mp2enc.exe"; DestDir: "{app}"; Components: movie
Source: "mjpeg\mpg123.exe"; DestDir: "{app}"; Components: movie
;Source: "C:\Programme\qt\bin\qt-mt230nc.dll"; DestDir: "{app}"; Components: main
;Source: "C:\Programme\qt3\bin\qt-mtnc321.dll"; DestDir: "{app}"; Components: main
Source: "C:\Qt3_Net\lib\qt-mtnc321.dll"; DestDir: "{app}"; Components: main
;Source: "C:\windows\system32\msvcp60.dll";  DestDir: "{sys}"; Flags: restartreplace uninsneveruninstall
;Source: "C:\windows\system32\msvcrt.dll";   DestDir: "{sys}"; Flags: restartreplace uninsneveruninstall
;Source: "C:\windows\system32\msvcrt.dll"; DestDir: "{app}"; Components: main
;Source: "C:\windows\system32\msvcp60.dll"; DestDir: "{app}"; Components: main
Source: "C:\windows\system32\msvcr71.dll"; DestDir: "{app}"; Components: main
Source: "C:\windows\system32\msvcp71.dll"; DestDir: "{app}"; Components: main
...
Name: "movie"; Description: "Movie/AVI Support"; Types: full; Languages: en nl;
...
Name: "movie"; Description: "Movie/AVI Unterstützung"; Types: full; Languages: de;
