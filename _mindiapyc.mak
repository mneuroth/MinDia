...
# Generated by qmake (1.04a) (Qt 3.1.1) on: Sat May 17 22:52:37 2003
...
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I$(QTDIR)/mkspecs/default -I. -I$(PYTHON_INC) -I/usr/include -I$(QTDIR)/include -Imoc/
LINK     = g++
...
OBJECTS = tmp/mindiapy.o \
		...
		tmp/ScriptDlg.o
FORMS = ScriptDlg.ui
UICDECLS = ScriptDlg.h
UICIMPLS = ScriptDlg.cpp
...
tmp/mindiapy.o: mindiapy.cpp dllbase.h \
		minbase.h \
		minhandle.h \
		iscript.h \
		scriptfcn.h \
		dllexport.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/mindiapy.o mindiapy.cpp

tmp/scriptfcn.o: scriptfcn.cpp scriptfcn.h \
		minhandle.h \
		minutils.h \
		osdep2.h \
		scriptdlgimpl.h \
		...
		dllbase.h \
		ScriptDlg.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/scriptfcn.o scriptfcn.cpp

tmp/minutils.o: minutils.cpp minutils.h \
		osdep2.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/minutils.o minutils.cpp

tmp/scriptdlgimpl.o: scriptdlgimpl.cpp scriptdlgimpl.h \
		minutils.h \
		ScriptDlg.h \
		minbase.h \
		iscript.h \
		dllexport.h \
		dllbase.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/scriptdlgimpl.o scriptdlgimpl.cpp

tmp/mindia_wrap.o: mindia_wrap.cpp mindia_wrap.c \
		iscript.h \
		minbase.h \
		dllexport.h \
		dllbase.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/mindia_wrap.o mindia_wrap.cpp

ScriptDlg.h: ScriptDlg.ui 
	$(UIC) ScriptDlg.ui -o ScriptDlg.h

ScriptDlg.cpp: ScriptDlg.h ScriptDlg.ui 
	$(UIC) ScriptDlg.ui -i ScriptDlg.h -o ScriptDlg.cpp

tmp/ScriptDlg.o: ScriptDlg.cpp ScriptDlg.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/ScriptDlg.o ScriptDlg.cpp

tmp/moc_scriptfcn.o: moc/moc_scriptfcn.cpp scriptfcn.h iscript.h \
		minbase.h \
		dllexport.h \
		dllbase.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/moc_scriptfcn.o moc/moc_scriptfcn.cpp

tmp/moc_scriptdlgimpl.o: moc/moc_scriptdlgimpl.cpp scriptdlgimpl.h ScriptDlg.h \
		minbase.h \
		iscript.h \
		dllexport.h \
		dllbase.h
...
tmp/moc_ScriptDlg.o: moc/moc_ScriptDlg.cpp ScriptDlg.h 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tmp/moc_ScriptDlg.o moc/moc_ScriptDlg.cpp

moc/moc_scriptfcn.cpp: $(MOC) scriptfcn.h
	$(MOC) scriptfcn.h -o moc/moc_scriptfcn.cpp

moc/moc_scriptdlgimpl.cpp: $(MOC) scriptdlgimpl.h
	$(MOC) scriptdlgimpl.h -o moc/moc_scriptdlgimpl.cpp

moc/moc_ScriptDlg.cpp: $(MOC) ScriptDlg.h
	$(MOC) ScriptDlg.h -o moc/moc_ScriptDlg.cpp
